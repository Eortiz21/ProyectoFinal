...
namespace PoyectoParqueo.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public TicketsController(ERPDbContext context)
        {
            _context = context;
        }
        ...
        {
            var eRPDbContext = _context.Tickets.Include(t => t.EspacioEstacionamiento).Include(t => t.Tarifa).Include(t => t.Vehiculo);
        ...
        {
            ViewData["Id_Espacio"] = new SelectList(_context.EspaciosEstacionamiento, "Id_Espacio", "Id_Espacio");
            ViewData["Id_Tarifa"] = new SelectList(_context.Tarifas, "Id_Tarifa", "Id_Tarifa");
        ...
        public async Task<IActionResult> Create([Bind("Id_Ticket,NoPlaca,Id_Espacio,Fecha_hora_entrada,Fecha_hora_salida,Id_Tarifa,PagoTotal")] Ticket ticket)
        {
            ...
            ViewData["Id_Espacio"] = new SelectList(_context.EspaciosEstacionamiento, "Id_Espacio", "Id_Espacio", ticket.Id_Espacio);
            ViewData["Id_Tarifa"] = new SelectList(_context.Tarifas, "Id_Tarifa", "Id_Tarifa", ticket.Id_Tarifa);
