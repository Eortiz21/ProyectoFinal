...
namespace laboratorio1ElvisOrtiz160625.Controllers
{
    public class DetalleVentasController : Controller
    {
        ...
        public DetalleVentasController(ERPDbContext context)
        {
            _context = context;
        }
        ...
        {
            var eRPDbContext = _context.DetalleVentas.Include(d => d.Producto).Include(d => d.Venta);
        ...
        public async Task<IActionResult> Create([Bind("Id,VentaId,ProductoId,Cantidad,PrecioUnitario,Subtotal")] DetalleVenta detalleVenta)
        {
            if (ModelState.IsValid)
            {
                detalleVenta.Id = Guid.NewGuid();
                _context.Add(detalleVenta);
                await _context.SaveChangesAsync();
                return RedirectToAction(nameof(Index));
            }
            ViewData["ProductoId"] = new SelectList(_context.tblProductos, "IdProducto", "Categoria", detalleVenta.ProductoId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,VentaId,ProductoId,Cantidad,PrecioUnitario,Subtotal")] DetalleVenta detalleVenta)
        {
